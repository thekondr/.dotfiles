(defun tool/delete-all-buffers-and-frame()
...
(defun mergetool/ediff-quit-merge-hook ()
  ...
  (tool/delete-all-buffers-and-frame))

(defun comparetool/ediff-quit-hook ()
  (remove-hook 'ediff-quit-hook 'comparetool/ediff-quit-hook)
  (tool/delete-all-buffers-and-frame))

(defun tk/comparetool (file-a file-b)
  (add-hook 'ediff-quit-hook #'comparetool/ediff-quit-hook)
  (with-demoted-errors
