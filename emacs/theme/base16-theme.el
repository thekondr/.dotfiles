...
;;;; tk overrides
     ...
     (diff-hl-delete                               :foreground base08 :background base08)
     (diff-hl-insert                               :foreground base0B :background base0B)
     (widget-button)
     (js2-jsdoc-html-tag-delimiter                 :foreground base0B)
     (js2-jsdoc-html-tag-name                      :foreground base0A)
     ...
     (helm-header-line-left-margin                 :weight bold)
     (helm-match-item                              :inherit helm-match)
     (helm-prefarg                                 :foreground base0B)
     (helm-swoop-line-number-face                  :foreground base03)
     (helm-swoop-target-line-block-face            :foreground base00 :background base09)
     (helm-swoop-target-line-face                  :inherit helm-selection-line)
     (helm-swoop-target-word-face                  :inherit helm-match)
     (avy-lead-face-0                              :foreground base0D)
     (avy-lead-face-1                              :foreground base05)
     (avy-lead-face-2                              :foreground base0E)
     (avy-lead-face                                :foreground base08)
     (ediff-current-diff-A                         :background base02)
     (ediff-current-diff-B                         :background base02)
     (ediff-current-diff-C                         :background base02)
     (ediff-current-diff-Ancestor                  :background base02)
     (ediff-fine-diff-A                            :foreground base00 :background base08)
     (ediff-fine-diff-B                            :foreground base00 :background base0B)
     (ediff-fine-diff-C                            :foreground base00 :background base0A)
     (ediff-fine-diff-Ancestor                     :foreground base00 :background base0C)
     (ediff-even-diff-A                            :background base01)
     (ediff-even-diff-B                            :background base01)
     (ediff-even-diff-C                            :background base01)
     (ediff-even-diff-Ancestor                     :background base01)
     ...
     (magit-bisect-bad                             :foreground base08)
     (magit-bisect-good                            :foreground base0B)
     (magit-bisect-skip                            :foreground base0A)
     (magit-blame-date                             :foreground base0A :background base01)
     (magit-blame-hash                             :foreground base0A :background base01)
     (magit-blame-heading                          :foreground base0A :background base01)
     (magit-blame-name                             :foreground base0A :background base01)
     (magit-blame-summary                          :foreground base0A :background base01)
     ...
     (magit-diff-base                              :foreground base0A)
     (magit-diff-base-highlight                    :inherit (magit-diff-base magit-section-highlight))
     (magit-diff-conflict-heading                  :background base02)
     (magit-diff-context                           :foreground base03)
     (magit-diff-context-highlight                 :inherit (magit-diff-context magit-section-highlight))
     (magit-diff-file-heading                      :foreground base06)
     (magit-diff-hunk-heading )
     (magit-diff-hunk-heading-highlight            :inherit magit-section-highlight)
     (magit-diff-lines-heading                     :background base02)
     (magit-diff-removed                           :foreground base08)
     (magit-diff-removed-highlight                 :inherit (magit-diff-removed magit-section-highlight))
     (magit-diffstat-added                         :foreground base0B)
     (magit-diffstat-removed                       :foreground base08)
     (magit-hash                                   :foreground base03)
     (magit-head                                   :inherit magit-branch-local)
     (magit-header-line                            :foreground base09)
     (magit-log-author                             :foreground base08)
     (magit-log-date                               :foreground base03)
     (magit-log-graph                              :foreground base04)
     (magit-section-heading                        :foreground base09)
     (magit-section-heading-selection              :foreground base0B)
     (magit-section-highlight                      :background base01)
     (magit-section-secondary-heading              :foreground base0A)
     (magit-tag                                    :foreground base0A)
     (diff-refine-added ((t nil)))
     (diff-refine-removed ((t nil)))
     (company-tooltip                              :foreground base04 :background base01)
     (company-tooltip-selection                    :foreground base04 :background base02)
     (company-tooltip-search                       :foreground base01 :background base0A)
     (company-tooltip-search-selection             :inherit company-tooltip-search)
     (company-template-field                       :inherit company-tooltip-selection)
     (ac-candidate-face                            :inherit company-tooltip)
     (ac-selection-face                            :inherit company-tooltip-selection)
     (popup-isearch-match                          :inherit company-tooltip-search)
     (neo-file-link-face                           :foreground base05)
     (neo-button-face                              :inherit neo-file-link-face)
     (neo-dir-link-face                            :foreground base0D)
     (neo-expand-btn-face                          :inherit neo-dir-link-face)
     (neo-root-dir-face                            :foreground base0C)
     (neo-banner-face                              :foreground base0B)
     (neo-header-face                              :foreground base0A)
     (helm-selection                               :inherit highlight)
     (helm-selection-line                          :inherit helm-selection)
     (linum-relative-current-face                  :foreground base08 :background base01 :weight bold)
     (line-number-current-line                     :foreground base0B :background base01 :weight bold)
     (sp-show-pair-match-face                      :background base01 :foreground base0B :weight bold)
     (sp-show-pair-mismatch-face                   :background base01 :foreground base08 :weight bold)
     (escape-glyph                                 :foreground base0F)
     (iedit-occurrence                             :background base02)
     (ac-completion-face                           :foreground base03)
     (company-preview-common                       :foreground base03)
     (company-preview                              :inherit highlight)
     (company-scrollbar-bg                         :background base03)
     (company-scrollbar-fg                         :background base05)
     (company-template-field                       :foreground base01 :background base0A)
     (company-tooltip                              :foreground base05 :background base02)
     (company-tooltip-annotation                   :foreground base08)
     (company-tooltip-selection                    :foreground base01 :background base0C)
     (ggtags-highlight ((t nil)))
     (spacemacs-emacs-face                         :foreground base01 :background base0D)
     (spacemacs-evilified-face                     :foreground base01 :background base0F)
     (spacemacs-hybrid-face                        :inherit spacemacs-emacs-face)
     (spacemacs-iedit-face                         :foreground base01 :background base08)
     (spacemacs-iedit-insert-face                  :inherit spacemacs-iedit-face)
     (spacemacs-insert-face                        :foreground base01 :background base0B)
     (spacemacs-lisp-face                          :foreground base01 :background base0D)
     (spacemacs-motion-face                        :foreground base01 :background base0E)
     (spacemacs-normal-face                        :foreground base01 :background base09)
     (spacemacs-replace-face                       :foreground base01 :background base08)
     (spacemacs-visual-face                        :foreground base01 :background base05)
     (spacemacs-helm-navigation-ms-face            :foreground base0B)
     (spacemacs-ido-navigation-ms-face             :foreground base0B)
     (vhl/default-face                             :background base01)
     (eval-sexp-fu-flash                           :foreground base0B :background base01)
     (eval-sexp-fu-flash-error                     :foreground base08 :background base01)
     (evil-snipe-matches-face ((t)))
     (evil-snipe-first-match-face ((t)))
     (ahs-definition-face                          :foreground base0A :underline t)
     (ahs-edit-mode-face                           :foreground base09)
     (ahs-face                                     :foreground base0A)
     (ahs-plugin-bod-face                          :foreground base0D)
     (ahs-plugin-defalt-face                       :foreground base0B)
     (ahs-plugin-whole-buffer-face                 :foreground base0A)
     (ahs-warning-face                             :foreground base08)
     (hydra-face-red                               :foreground base08)
     (hydra-face-blue                              :foreground base0D)
     (hydra-face-pink                              :foreground base0E)
     (hydra-face-teal                              :foreground base0C)
     (hydra-face-amaranth                          :foreground base09)
...
;;;; ivy-mode
     ...
     (ivy-minibuffer-match-face-1                  :foreground base0B)
     (ivy-minibuffer-match-face-2                  :foreground base08)
     (ivy-minibuffer-match-face-3                  :foreground base08)
     (ivy-minibuffer-match-face-4                  :foreground base08)
