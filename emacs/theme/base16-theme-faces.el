;; base16-theme-faces.el -- base16 themes for emacs
...
(defun base16-transform-face (spec colors)
  ...
  (let* ((face       (car spec))
    ...
    (list face `((((type graphic)) ,(base16-transform-spec definition colors))
                 (((type tty))     ,(base16-transform-spec definition base16-shell-colors))))))
...
(provide 'base16-theme-faces)

;;; base16-theme-faces.el ends here
